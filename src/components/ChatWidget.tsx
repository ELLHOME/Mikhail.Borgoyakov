...
const STR = {
  ru: {
    ...
    greetingGuide:
      "wikiмантия — гадание по энциклопедии. Спросите о чём угодно — найду статью и расскажу. А хотите погадать — задумайте вопрос и назовите номер страницы и строки: что окажется на этих координатах, то и будет ответом.",
    placeholderGuide: "Спросите или скажите «погадай»",
  ...
  en: {
    ...
    greetingGuide:
      "wikimancy — divination by encyclopedia. Ask about anything and I'll look it up. Or divine: think of a question and name a page and line number — whatever sits at those coordinates is your answer.",
    placeholderGuide: "Ask something, or say “divine”",
