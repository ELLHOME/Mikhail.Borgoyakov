  ...
  ru: {
    ...
    lab: {
      ...
      items: [
        ...
        {
          n: "05", t: "СКАЛА", img: `${BASE}works/04.webp`, kind: "product",
          video: `${BASE}works/skala.mp4`, keyOn: "black",
        ...
        {
          n: "06", t: "Lynq", img: `${BASE}works/05.webp`, kind: "product",
          video: `${BASE}works/lynq.mp4`, keyOn: "white",
  ...
  en: {
    ...
    lab: {
      ...
      items: [
        ...
        {
          n: "05", t: "SKALA", img: `${BASE}works/04.webp`, kind: "product",
          video: `${BASE}works/skala.mp4`, keyOn: "black",
